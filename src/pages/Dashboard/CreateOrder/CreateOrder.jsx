...
export default function CreateOrder() {
  ...
  if(isMobile)return (
    <div className="p-2">
      <h1 className="text-2xl mb-2 w-full border-b-2 pb-2">Create Order</h1>
      <div className="flex flex-col px-2 py-5">
        {/* Customer name and Total */}
        <div className="w-full grid grid-cols-5 items-center gap-3">
          {/* Customer name */}
          <div className="flex items-center gap-2 mb-5 col-span-3">
            <label className="text-xl" htmlFor="name">Customer: </label>
            <input className="w-full rounded-xl px-2 py-1" type="text" />
          </div>
          {/* Total */}
          <div className="flex items-center gap-2 mb-5 col-span-2">
            <label className="text-xl" htmlFor="name">Total: </label>
            <div className="py-1 px-2 text-center">
              <h1 className="text-xl">{totalValue} PHP</h1>
            </div>
